                        ...
                        <form method="post" name="form_new_cliente_venta" id="form_new_cliente_venta">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>RTN</label>
                                        <input type="number" name="rtn_cliente" id="rtn_cliente" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <p style="font-size: 16px; text-transform: uppercase; color: blue;">BAYRON ALBERTO MERAZ</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label>Acciones</label>
                        <div id="acciones_venta" class="form-group">
                            <a href="#" class="btn btn-danger" id="btn_anular_venta"><i class="fas fa-exclamation-triangle"></i> Anular</a>
                            <a href="#" class="btn btn-primary" id="btn_facturar_venta"><i class="fas fa-save"></i> Generar Venta</a>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <label>CAI</label>
                        <p style="font-size: 16px; text-transform: uppercase; color: blue;">0000-0000-000-0000-000</p>
                    </div>
                </div>
